...
(function (angular) {
    ...
    var MainHeaderCtrl = function MainHeaderCtrl($scope, backgroundAnimationService, geocodingService, forecastRequestService, forecastFormatService, displayForecastService) {
        var $ctrl = this;
        ...
        $ctrl.getLocationConditions = function getLoactionConditions() {
            ...
            function requestForecast(latLng) {
                forecastRequestService.forecastRequestByLatLng(latLng.lat, latLng.lng).then(function (response) {
    ...
    angular.module('wvApp').component('mainHeader', {
        ...
        $routeConfig: [{ path: '/current-weather/', name: 'CurrentWeather', component: 'currentWeather', useAsDefault: true }, { path: '/five-day-forecast/', name: 'FiveDayForecast', component: 'fiveDayForecast' }, { path: '/ten-day-forecast/', name: 'TenDayForecast', component: 'tenDayForecast' }]
    });
})(window.angular);
