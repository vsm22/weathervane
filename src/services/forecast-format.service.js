(function(angular){
  ...
  angular.module('wvApp').service('forecastFormatService', [
      function forecastFormat() {
        ...
        this.formatWeather = function formatWeather (rawWeather) {
          ...
          let formatedWeatherPromise = new Promise(function(resolve, reject) {
            let w = _this.currentWeather; //formated output object
            let date = new Date();
            ...
            _this.currentWeather.time = w.hoursString
                     + ':' + w.minutesString
                     + ((w.hours >= 12) ? ' pm' : ' am');
